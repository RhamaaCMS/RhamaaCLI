...
def download_github_repo(repo_url, branch="main", progress=None, task_id=None):
    ...
    try:
        if progress and task_id:
            progress.update(task_id, description="[cyan]Downloading repository...")
...
def check_wagtail_project():
    ...
    """
    # Check for common Wagtail project indicators
    indicators = [
        "manage.py",
        "settings.py",
        "requirements.txt"
    ...
    # Check if manage.py exists and contains wagtail references
